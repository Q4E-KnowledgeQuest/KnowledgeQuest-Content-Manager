/*
 * File: dbmanager.go
 * File Created: Tuesday, 21st June 2022 7:42:35 pm
 * Author: Akhil Datla
 * © 2022 Akhil Datla
 */
...
//GroupQuery executes a query for multiple records given a struct
func GroupQuery(fieldName string, value, to interface{}) error {
	err := db.Find(fieldName, value, to)
	return err
}

//QueryAll executes queries for all the data with the given struct
